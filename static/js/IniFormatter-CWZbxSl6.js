import{T as I}from"./index-fKt_YgYO.js";import{_ as f,c as u,o as p,a as y,b as i,r as v,w as c,d,v as m,t as h}from"./index-dL88sIup.js";import"./monaco-editor-mVv4Ass3.js";const b={name:"IniFormatter",components:{ToolSwitcher:I},data(){return{inputIni:"",outputIni:"",error:null,copyMessage:""}},methods:{formatIni(){if(this.error=null,this.outputIni="",!this.inputIni.trim()){this.error="Please enter INI content to format.";return}try{const r=this.inputIni.split(`
